...
#Inputs:
#ref from Bionmon_Phoenix.mdb
#impaired from 'midcoast_new_status.csv'
#ssn1 from 04_Transformations.R
#max_log10_fss from 04_Transformations.R


#Gather reference site info for determining reference condition
con <- odbcConnectAccess('//deqlab1/biomon/Databases/Biomon_Phoenix.mdb', readOnly = TRUE)
...
fit <- glmssn( log10_FSS_26Aug14 ~ STRMPWR + EROD_PARCA + MIN_Z + OWN_FED_PRCA + 
                 SQM_ARCA + OWN_URB_PARCA + ROADLEN_DARCA + HDWTR, 
              EstMeth = "REML",
              ssn1,
